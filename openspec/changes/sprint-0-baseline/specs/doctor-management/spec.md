## Purpose
Gestionar los perfiles profesionales de médicos y especialistas, incluyendo matrículas profesionales, credenciales, catálogo de especialidades clínicas y asignación de áreas de atención con aislamiento lógico por inquilino (`tenant_id`) en la plataforma SaaS (CU04).
